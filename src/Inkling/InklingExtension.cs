...
public sealed partial class InklingExtension : IExtension, IDisposable
{
    private readonly ManualResetEvent _extensionDisposedEvent;
    private readonly InklingCommandsProvider _provider = new();

    public InklingExtension(ManualResetEvent extensionDisposedEvent)
    {
