...
| Delete | `Ctrl+D` on the list page; after confirming, the file **goes to the Recycle Bin**, and a line at the bottom names what went. On a network drive, or a device without a Recycle Bin, Windows deletes it for good instead — the **Delete notes** page spells this out in its details pane |
